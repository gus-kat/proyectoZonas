...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Los siguientes mensajes de validación están traducidos al español.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes personalizados para reglas específicas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí asignamos nombres más amigables para los atributos.
    |
    */
    ...
    'attributes' => [
        ...
        'gender' => 'género',
        'message' => 'mensaje',
        // Agrega aquí más según tus campos usados...
    ],
